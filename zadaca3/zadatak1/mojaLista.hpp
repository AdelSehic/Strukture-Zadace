...
template <typename T>
T& mojaLista<T>::front() { return front_ -> data; }

template <typename T>
T& mojaLista<T>::back() { return back_ -> data; }
...
template <typename T>
typename mojaLista<T>::iterator mojaLista<T>::begin() { return front_; }

template <typename T>
typename mojaLista<T>::iterator mojaLista<T>::end() { return back_; }
...
template <typename T>
bool mojaLista<T>::operator!=(const mojaLista<T>& other){ return !(*this == other); }